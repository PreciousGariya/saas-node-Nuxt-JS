      ...
      <div class="card card-body flex-grow-1 mx-auto border-0 shadow-sm" style="max-width: 28rem;">
        ...
        <form class="js-validate needs-validation">
          ...
          <div class="mb-4">
            ...
            <input type="email" v-model="user.email" class="form-control form-control-lg" name="email" id="signupSimpleLoginEmail" placeholder="email@site.com" aria-label="email@site.com">
          ...
          <div class="text-center">
            <p>Don't have an account yet? <NuxtLink to="/auth/register" class="link">Sign up here</NuxtLink></p>
          </div>
        </form>
        <!-- End Form -->
      </div>
